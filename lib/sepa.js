...
(function(exports) {
  ...
  SepaPaymentInfo.prototype = {
    ...
    validate: function() {
      ...
      assert_length(this.creditorBIC, [0,8,11], "creditorBIC");
      var countryMatches = (this.creditorBIC.length == 0 || this.creditorBIC.substr(4, 2) == this.creditorIBAN.substr(0, 2));
    ...
    toXML: function(doc) {
      ...
      if (this.creditorBIC) {
        ...
        r(pmtInf, "CdtrAgnt", "FinInstnId", "Othr", "Id", "NOTPROVIDED")
      }
  ...
  SepaTransaction.prototype = {
    ...
    validate: function() {
      ...
      assert_fixed(this.debitorBIC.length, [0, 8,11], "debitorBIC");
      var countryMatches = (this.debitorBIC.length == 0 || this.debitorBIC.substr(4, 2) == this.debitorIBAN.substr(0, 2));
      assert(countryMatches, "country mismatch in BIC/IBAN");
