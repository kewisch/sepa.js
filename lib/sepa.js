...
(function(exports) {
  ...
  SepaDocument.prototype = {
    ...
    toXML: function() {
      ...
      var rootElement = doc.createElementNS(docNS, this.type);
  ...
  SepaPaymentInfo.prototype = {
    ...
    /** SEPA payment method. */
    method: PaymentInfoTypes.DirectDebit,
     ...
     *
     * @param pmt       The SepaDirectDebitTransaction to add.
     */
  ...
  GenericTransaction.TransactionTypes = TransactionTypes;

  GenericTransaction.prototype = {
    ...
    toXML: function(doc) {
      ...
      var pullFrom = this._type === TransactionTypes.Transfer ? 'creditor' : 'debtor';
      var recieverNodeName = this.method === PaymentInfoTypes.DirectDebit ? 'Cdtr' : 'Dbtr';
   ...
   */
  function SepaDirectDebitTransaction() {
  }

  SepaDirectDebitTransaction.prototype = {
    ...
    validate: function() {
      ...
      assert_length(this.debtorName, null, 70, "debtorName");
      assert_length(this.debtorStreet, null, 70, "debtorStreet");
      assert_length(this.debtorCity, null, 70, "debtorCity");
      assert_length(this.debtorCountry, null, 2, "debtorCountry");
      assert_iban(this.debtorIBAN, "debtorIBAN");
      assert_fixed(this.debtorBIC.length, [0, 8, 11], "debtorBIC");
      var countryMatches = (this.debtorBIC.length === 0 || this.debtorBIC.substr(4, 2) == this.debtorIBAN.substr(0, 2));
      assert(countryMatches, "country mismatch in BIC/IBAN");
    ...
    toXML: function(doc) {
      ...
      if (this.debtorBIC) {
        r(txInf, "DbtrAgt", "FinInstnId", "BIC", this.debtorBIC);
      } else {
        r(txInf, "DbtrAgt", "FinInstnId", "Othr", "Id", "NOTPROVIDED");
      }
      var debtor = n(txInf, "Dbtr");
      r(debtor, "Nm", this.debtorName);
      if (this.debtorStreet && this.debtorCity && this.debtorCountry) {
        var pstl = n(debtor, "PstlAdr");
        r(pstl, "Ctry", this.debtorCountry);
        r(pstl, "AdrLine", this.debtorStreet);
        r(pstl, "AdrLine", this.debtorCity);
      }
      r(txInf, "DbtrAcct", "Id", "IBAN", this.debtorIBAN);
  ...
  exports.Transaction = GenericTransaction.bind(undefined, GenericTransaction.TransactionTypes.DirectDebit); // For non-breaking change
