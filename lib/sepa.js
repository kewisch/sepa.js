...
(function(exports) {
  ...
  function SepaDocument(painFormat, options) {
    ...
    if (options !== undefined) {
      if ('includeSchemaLocation' in options) {
        this._includeSchemaLocation = options.includeSchemaLocation;
      }
    }
  }
  ...
  SepaDocument.prototype = {
    ...
    /** If set to false will not include the schema location as part of the header. */
    _includeSchemaLocation: true,
    ...
    toXML: function() {
      ...
      // some bank like portuguese bank do not accept a header too long. and this is optional.
      if (this._includeSchemaLocation) {
  ...
  SepaTransaction.prototype = {
    ...
    toXML: function(doc) {
      ...
      if (this.categoryPurpose) {
        r(txInf, 'PmtTpInf', 'CtgyPurp', 'Cd', this.categoryPurpose);
      }
