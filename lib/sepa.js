...
(function(exports) {
  ...
  SepaGroupHeader.prototype = {
    ...
    toXML: function(doc) {
      ...
      if (getPainXMLVersion(this._painFormat) === 2) {
  ...
  SepaPaymentInfo.prototype = {
    ...
    toXML: function(doc) {
      ...
      if (getPainXMLVersion(this._painFormat) === 3) {
        r(pmtInf, 'BtchBookg', this.batchBooking.toSring());
        r(pmtInf, 'Grpg', this.grouping);
      ...
      r(pmtTpInf, 'LclInstrm', 'Cd', this.method === PaymentInfoTypes.DirectDebit ? this.localInstrumentation : 'TRF');
