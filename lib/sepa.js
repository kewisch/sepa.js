 ...
 * SEPA.enableValidations  -- function to enable/disable fields validation (takes boolean parameter to express enabled)
 */
(function(exports) {
  ...
  SepaGenericTransaction.prototype = {
    ...
    toXML: function(doc) {
      ...
      // TODO this doesn't validate: r(txInf, 'InstrId', this.id);
      r(txInf, 'InstrId', this.id);
