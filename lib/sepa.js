...
(function(exports) {
  ...
  SepaGroupHeader.prototype = {
    ...
    toXML: function(doc) {
      ...
      if (this.organisationId) {
        r(initgPty, 'Id', 'OrgId', 'Othr', 'Id', this.organisationId);
      }
  ...
  SepaPaymentInfo.prototype = {
    ...
    toXML: function(doc) {
      ...
      o(pmtTpInf, 'CtgyPurp', 'Cd', this[pullFrom + 'CategoryPurpose']);
      ...
      if (this[pullFrom + 'BIC']) {
        var finInstnId = n(pmtInf, emitterNodeName + 'Agt', 'FinInstnId');
        r(finInstnId, 'BIC', this[pullFrom + 'BIC']);
        o(finInstnId, 'PstlAdr', 'Ctry', this[pullFrom + 'Country']);
      } else {
  ...
  SepaTransaction.prototype = {
    ...
    toXML: function(doc) {
      ...
      if (this[pullFrom + 'BIC']) {
        var finInstnId = n(txInf, recieverNodeName + 'Agt', 'FinInstnId');
        r(finInstnId, 'BIC', this[pullFrom + 'BIC']);
        o(finInstnId, 'PstlAdr', 'Ctry', this[pullFrom + 'Country']);
      } else {
